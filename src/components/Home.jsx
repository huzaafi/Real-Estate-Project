...
const Home = ({ home, provider, account, escrow, togglePop }) => {
    ...
    const fetchDetails = async () => {
        ...
        const hasBought = await escrow.approve(home.id, buyer)
        ...
        const hasSold = await escrow.approve(home.id, seller)
        setHasSold(hasSold)
        ...
        const hasLended = await escrow.approve(home.id, lender)
            ...
            <div className='home__details'>
                ...
                <div className="home__overview">
                    ...
                    <p>
                        ...
                        <strong>{home.attributes[4].value}</strong> ba |
